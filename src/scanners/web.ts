...
const DANGEROUS_HEADERS = [
  { name: 'x-powered-by', severity: 'low' as const, description: 'X-Powered-by header exposes server technology' },
  { name: 'server', severity: 'low' as const, description: 'Server header exposes server version information' },
];
